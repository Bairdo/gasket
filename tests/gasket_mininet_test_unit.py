...
class GasketNamedPortRulesTest(GasketOneSwitchTest):
...
class GasketRuleReferenceTest(GasketOneSwitchTest):
...
class GasketRuleListReferencesTest(GasketOneSwitchTest):

...
python3 /gasket-src/faucet/rule_manager.py /etc/ryu/faucet/base-acls.yaml /etc/ryu/faucet/faucet-acls.yaml
echo "Starting Faucet"
ryu-manager faucet.faucet &
echo $! > /etc/ryu/faucet/contr_pid
echo "Starting auth_app"
python3.5 /gasket-src/faucet/auth_app.py --config /etc/ryu/faucet/auth.yaml
